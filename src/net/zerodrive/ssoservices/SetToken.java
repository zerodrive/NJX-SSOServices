...
public class SetToken implements IAdapterListener {
  ...
  /*
   * When the user clicks the "Connect" button on the Logon page, encrypt userID and password using
   * the public key of a given key pair and store the encrypted value in the session context.
   */
  @Override
