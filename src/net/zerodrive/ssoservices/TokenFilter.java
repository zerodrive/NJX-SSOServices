...
public class TokenFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
    ...
    HttpServletRequestWrapper requestMod = new HttpServletRequestWrapper(
      ...
      /*
       * If userID or password are requested, we check if the parameter "token" is specified and try
       * to extract userID and password from the token.
       */
      @Override
      public String getParameter(String parm) {
        ...
        if (parm.equals(userParm) || parm.equals(pwdParm)) {
          ...
          /*
           * As a safeguard against misuse of the token we accept the token only if it is not older
           * than two seconds.
           */
      ...
      public String getQueryString() {
        ...
        /*
         * As a safeguard against misuse of the token we accept a token only if the query originates
